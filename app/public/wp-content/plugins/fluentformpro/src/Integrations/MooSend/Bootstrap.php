...
//        add_filter('fluentform_notifying_async_moosend', '__return_false');
    ...
    public function saveGlobalSettings($settings)
    {
        ...
        wp_send_json_success([
            'message' => __('Your MooSend api key has been verfied and successfully set', 'fluentformpro'),
            'status'  => true
        ], 200);
    }
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        $cutomFields = ArrayHelper::get($feedData, 'CustomFields', []);

        $subscriber['CustomFields'] = $cutomFields;
        ...
        do_action('ff_log_data', [
            ...
            'status' => 'success',
            'title' => $feed['settings']['name'],
            'description' => 'Moosend feed has been successfully initialed and pushed data'
        ]);
