...
class Bootstrap extends IntegrationManager
{
    ...
    public function saveGlobalSettings($settings)
    {
        ...
        wp_send_json_success([
            'message' => __('Your SendFox api key has been verfied and successfully set', 'fluentformpro'),
            'status'  => true
        ], 200);
    }
    ...
    public function getIntegrationDefaults($settings, $formId)
    {
        return [
            'name'                   => '',
            'SubscriberFirstName'         => '', // Name in MooSend
            'SubscriberLastName'         => '', // Name in MooSend
            'Email'                  => '',
            'CustomFields'           => (object)[],
            'list_id'                => '', // SendFox
            'conditionals'           => [
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if (!$result) {
            ...
            do_action('ff_log_data', [
                ...
                'status' => 'success',
                'title' => $feed['settings']['name'],
                'description' => 'SendFox feed has been successfully initialed and pushed data'
            ]);
        }
