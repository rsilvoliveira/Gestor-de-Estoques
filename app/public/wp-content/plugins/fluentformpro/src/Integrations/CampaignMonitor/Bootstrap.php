...
//        add_filter('fluentform_notifying_async_campaign_monitor', '__return_false');
        ...
        return [
            'fields'              => [
                ...
                [
                    ...
                    'checkobox_label' => 'Enable ReSubscription'
                ],
                [
                    'require_list' => true,
                    'key'          => 'conditionals',
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        try {
            ...
            $api = $this->getApiClient();
            $response = $api->add_subscriber($subscriber, $feedData['list_id']);
            // It's success
            do_action('ff_log_data', [
                ...
                'description' => 'Campaign Monitor feed has been successfully initialed and pushed data'
            ]);
