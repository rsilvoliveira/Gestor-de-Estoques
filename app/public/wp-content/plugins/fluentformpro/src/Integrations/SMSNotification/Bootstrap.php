...
//        add_filter('fluentform_notifying_async_sms_notification', '__return_false');
    ...
    public function saveGlobalSettings($settings)
    {
        ...
        wp_send_json_success([
            'message' => __('Your Twillio api key has been verfied and successfully set', 'fluentformpro'),
            'status'  => true
        ], 200);
    }
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        $smsData = [
            ...
            'From' => str_replace(' ', '',$apiSettings['senderNumber']),
            'To'   => str_replace(' ', '', $feedData['receiver_number'])
        ];
        ...
        if (is_wp_error($response)) {
            ...
            do_action('ff_log_data', [
                ...
                'status' => 'success',
                'title' => $feed['settings']['name'],
                'description' => 'Twilio SMS feed has been successfully initialed and pushed data'
            ]);
        }
    }
