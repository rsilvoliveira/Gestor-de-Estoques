...
class Bootstrap extends IntegrationManager
{
    public function __construct(Application $app)
    {
        ...
        $this->description = 'WP Fluent Forms ActiveCampaign Module allows you to create ActiveCampaign list signup forms in WordPress, so you can grow your email list.';
        ...
        return [
            'fields'              => [
                ...
                [
                    ...
                    'checkobox_label' => 'Enable Instant Responder'
                ],
                [
                    ...
                    'component'       => 'checkbox-single',
                    'checkobox_label' => 'Enable Send the last broadcast campaign'
                ],
                [
                    'require_list' => true,
                    'key'          => 'conditionals',
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if (!is_email($feedData['fieldEmailAddress'])) {
            do_action('ff_log_data', [
                ...
                'description' => 'Active Campaign API called skipped because not valid email available'
            ]);
            return;
        }
        ...
        $tags = array_map('trim', explode(',', ArrayHelper::get($feedData, 'tags')));
        if ($tags) {
            $addData['tags'] = $tags;
        }
        ...
        if (is_wp_error($response)) {
            ...
            do_action('ff_log_data', [
                ...
                'status' => 'success',
                'title' => $feed['settings']['name'],
                'description' => 'Active Campaign has been successfully initialed and pushed data'
            ]);
            return true;
        } else {
            ...
            do_action('ff_log_data', [
                ...
                'status' => 'failed',
                'title' => $feed['settings']['name'],
                'description' => $response['result_message']
            ]);
            return false;
        }
    }
