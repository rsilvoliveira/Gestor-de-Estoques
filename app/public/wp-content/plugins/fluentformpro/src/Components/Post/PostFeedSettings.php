...
class PostFeedSettings
{
    ...
    public function getPostSettings()
    {
        ...
        $data['acf_fields'] = $this->getAcfFields($postSettings->post_type);
    ...
    protected function getAcfFields($postType)
    {
        ...
        $formattedFields = [];
        $acceptedFields = ['text', 'textarea', 'number', 'email', 'url', 'password', 'wysiwyg', 'date_picker', 'date_time_picker', 'time_picker'];
