        ...
        enableFollowFiltering: function(){
            ...
            this.connectedWPDataTable.fnSettings().aoDrawCallback.push({
                ...
                fn: function( oSettings ){
                    ...
                    var dateSettingsFormat = jQuery.parseJSON( jQuery( '#'+obj.connectedWPDataTable.data('described-by') ).val() ).datepickFormat;
                    var timeSettingsFormat = jQuery.parseJSON( jQuery( '#'+obj.connectedWPDataTable.data('described-by') ).val() ).timeFormat;
