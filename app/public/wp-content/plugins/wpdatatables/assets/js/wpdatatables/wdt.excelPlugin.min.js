...
var tableDescription={};var description_element_id=$(this.hot.rootElement).data('described-by');if(description_element_id&&($descriptionElement=$('#'+description_element_id))){tableDescription=$.parseJSON($descriptionElement.val());this.tableSettings=tableDescription.dataTableParams;delete tableDescription.dataTableParams}
...
if(this.serverSide){this.tableSettings.minSpareRows=1;this.addContextMenuItems();Handsontable.Search.global.setDefaultCallback(this.wdtExcelSearchCallback);this.addHook('afterChange',this.onAfterChange.bind(this));this.addHook('init',this.onInit.bind(this));this.addHook('afterValidate',this.onAfterValidate.bind(this))}else{this.tableSettings.data=$.parseJSON($(tableDescription.selector+'_data').val());this.addHook('init',this.onInit.bind(this))}
...
if(!$parent_element.next('div.tooltip:visible ').length){$parent_element.attr('title','');$parent_element.tooltip({title:wpdatatables_frontend_strings.invalid_value})}
