...
(function ($) {
    $(function () {
        ...
        function activatePlugin() {
            ...
            let parsed = psl.parse(location.hostname);
            let domain = parsed.domain !== null ? parsed.domain : parsed.input;
            let subdomain = parsed.subdomain !== null ? parsed.subdomain : '';
            ...
            $.ajax({
                ...
                data: {
                    ...
                    purchaseCodeStore: $('#wdt-purchase-code-store').val(),
                    slug: 'wpdatatables',
                    domain: domain,
                    subdomain: subdomain
                },
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (parsedResponse.deactivated === true) {
                        wdt_current_config.wdtPurchaseCodeStore = '';
